...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CrescentCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"crescentmine.com", "crescentmine.com"},
    {"crescentcoinpool.org", "dnsseed.crescentcoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CrescentCoin is probably already running."), addrBind.ToString().c_str());
        else
